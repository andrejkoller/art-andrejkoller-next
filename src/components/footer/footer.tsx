...
export const Footer = () => {
  return (
    <footer className="fixed bottom-12 left-1/2 w-[calc(100%-128px)] -translate-x-1/2 z-10">
      <small
        className="
        text-foreground text-[0.5rem] leading-[18px] 
      ...
      >
        ...
        >
          <span
            className="
            bg-[url('/icon-linktree.svg')] bg-center bg-no-repeat 
            bg-[length:16px_16px] pointer-events-none 
            relative h-12 w-12 inline-block
            brightness-0 invert
          "
          ></span>
        </Link>
