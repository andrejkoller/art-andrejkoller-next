...
import { AdaptiveCursor } from "../adaptive-cursor/adaptive-cursor";
...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-1/2 mt-10 mx-auto w-[calc(100%-128px)] -translate-x-1/2 z-10 mix-blend-difference">
      <Link
        href="/"
        className="relative inline-block h-12 text-base leading-[50px] uppercase tracking-[6px] text-foreground after:absolute after:bottom-[4px] after:left-0 after:h-px after:w-[calc(100%-6px)] after:bg-foreground after:content-[''] after:inline-block after:scale-x-0 after:origin-right after:transition-transform after:duration-[400ms] after:ease-[cubic-bezier(.5,.25,0,1)] after:will-change-transform hover:after:scale-x-100 hover:after:origin-left"
      >
        Andrej Koller
      </Link>
